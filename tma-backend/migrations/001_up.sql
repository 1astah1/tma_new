...
INSERT INTO product_keys (product_id, key, status)
SELECT id, 'XXXXX-XXXXX-XXXXX-XXXX', 'available' FROM products WHERE title = 'Cyberpunk 2077';
INSERT INTO product_keys (product_id, key, status)
SELECT id, 'YYYYY-YYYYY-YYYYY-YYYY', 'available' FROM products WHERE title = 'Cyberpunk 2077';
INSERT INTO product_keys (product_id, key, status)
SELECT id, 'ZZZZZ-ZZZZZ-ZZZZZ-ZZZZ', 'available' FROM products WHERE title = 'FIFA 24';
INSERT INTO product_keys (product_id, key, status)
SELECT id, 'AAAAA-AAAAA-AAAAA-AAAA', 'available' FROM products WHERE title = 'V-Bucks 5000';

INSERT INTO admins (telegram_id, username, password_hash, roles, is_active) VALUES
    (111111, 'superadmin', '', '{super_admin,game_manager,activation_admin,support,finance}', true);
